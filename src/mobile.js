...
import s3Action from './mobile/s3-action.vue'
import s3Banner from './mobile/s3-banner.vue'
import s3Bottom from './mobile/s3-bottom.vue'
import s3Card from  './mobile/s3-card.vue'
import s3Date from './mobile/s3-date.vue'
import s3Dealer from './mobile/s3-dealer.vue'
...
import s3NoData from './mobile/s3-noData.vue'
...
const s3vue = function (Vue,options) {
  ...
  Vue.component(s3Action.name,s3Action);
  ...
  Vue.component(s3NoData.name,s3NoData);
